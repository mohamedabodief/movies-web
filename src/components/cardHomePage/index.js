...
import FavoriteToggle from '../FavoriteToggle'; // Ensure correct path
                ...
                >
                    <div className="position-relative">
                        ...
                        <img
                            ...
                            onError={(e) => {
                                e.currentTarget.src = 'https://placehold.co/500x750/cccccc/333333?text=No+Image';
                            }}
                        />

                        {/* Circular Vote Average Indicator */}
                        <div
                    ...
                    <div className="card-body px-1 pt-4 text-start">
                        ...
                        >
                            ...
                            {/* Favorite Toggle for the Card, positioned beside the date */}
                            {/* Pass variant="card" to remove absolute positioning and adjust size */}
